...
{
    const byte_t min = static_cast<byte_t>(Limits::Min);
    const byte_t max = type == ValueType::Channel ?
        static_cast<byte_t>(Limits::ChannelMax) : 
        static_cast<byte_t>(Limits::Max);
...
Midi::byte_t Midi::CombineStatusChannel(const Midi::Status status,
                                        const Midi::byte_t channel)
{
...
Midi::word_t Midi::CombinePitchBend(const Midi::byte_t fine,
                                    const Midi::byte_t coarse)
{
